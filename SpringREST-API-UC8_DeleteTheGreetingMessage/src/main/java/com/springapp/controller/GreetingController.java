...
public class GreetingController {
    ...
    public Optional<Greeting> editGreeting(@PathVariable Long id, @RequestBody String newMessage) {
        //Return the value
        return useService.editGreetingMessage(id, newMessage);
    }

    //Use @DeleteMapping Annotation
    @DeleteMapping("/delete/{id}")
    //Create a method deleteGreeting to delete greeting by id
    public String deleteGreeting(@PathVariable Long id) {
        //Call the method and return the value
        return useService.deleteGreetingMessage(id)?"Greeting Deleted" : "Not Found";
    }
}
